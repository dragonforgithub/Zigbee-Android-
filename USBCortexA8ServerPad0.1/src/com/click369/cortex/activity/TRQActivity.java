...
public class TRQActivity extends Activity implements OnClickListener{
			 ...
			 dataStr = dataStr.trim();
				...
				if(dataStr.contains("\r\n")){
					...
					for(int i = 0;i<length;i++){
						...
						zhuangtai = HexDump.hexStringToByteArray(datas[6])[0];
						if(zhuangtai!=0){
							qt_iv1.setImageResource(R.drawable.design_icon_on);
						}else if(zhuangtai==00){
