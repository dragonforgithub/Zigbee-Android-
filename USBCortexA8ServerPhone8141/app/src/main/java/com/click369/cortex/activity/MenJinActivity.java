...
//		System.out.println("jiedian = "+jiedian+"  0xB2"+0xB2 +"    "+(jiedian == 0xB2));
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lockIv.setImageResource(R.drawable.lock_off);
		lockTv.setText("关");
		failShowTv = (TextView)this.findViewById(R.id.menjin_urlfail_tv);
		failShowTv.setVisibility(View.GONE);
		failShowTv.setOnClickListener(this);
		addressTv = (TextView)this.findViewById(R.id.menjin_addr_tv);
		netNumTv = (TextView)this.findViewById(R.id.menjin_netNum_tv);
		singleTv = (TextView)this.findViewById(R.id.menjin_singelNum_tv);

//        String urlPath = "downLoad?leixing=af&name="+Util.boxNum;
		String urlPath = "lx=mj&bn="+Util.boxNum;
